    ...
    <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start', flexWrap: 'wrap' }}>
      ...
      <div className="headers-container">
        ...
        <div style={{ padding: 16, maxWidth: 960, marginTop: 18 }}>
          <h3>Uso</h3>
          <p style={{ color: '#444' }}>
            Você pode aplicar a classe de escala tanto diretamente no elemento de título (conforme mostrado no exemplo abaixo)
            quanto no contêiner pai (wrapper). Ambos os métodos produzem o mesmo resultado tipográfico — escolha o que for
            mais conveniente para o seu componente ou seção de página.
          </p>
...
<h4 class="headers--12">Legenda</h4>`}</code>
  ...
  <h4>Legenda</h4>
              ...
              <div style={{ marginTop: 12, border: '1px dashed #ddd', padding: 12 }}>
                <div className="headers--12">
                  <h1>Título principal</h1>
                  <h2>Subtítulo</h2>
                  <h3>Seção</h3>
