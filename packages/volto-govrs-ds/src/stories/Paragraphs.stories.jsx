    ...
    <div style={{ padding: 16, maxWidth: 960, marginTop: 18 }}>
      ...
      <ul style={{ color: '#444' }}>
        ...
        <li>
          ...
          <code>paragraph--12-short</code>, <code>paragraph--4-long</code>).
          Essa abordagem evita a necessidade de combinar uma classe de escala +
          uma classe de variante no mesmo elemento.
        </li>
      </ul>
    </div>
  </div>
