...
export const Documentacao = () => (
  <div style={{ padding: '40px', maxWidth: '950px', fontFamily: 'sans-serif' }}>
    <h1 style={{ marginBottom: '12px' }}>Componente de Menu</h1>
    ...
    <CodeBlock title="2. Cabeçalho: Logo" code={`<Menu logo="imagem.svg" />`} />
...
const InteractiveTemplate = (args) => {
  // Corrigida a string de exibição para mostrar um código válido
  const codeString = `
  ...
  return (
    ...
    >
      <div style={{ padding: '40px', background: '#fff' }}>
        ...
        <Menu {...args} />
        <h3 style={{ marginBottom: '16px', marginTop: '32px' }}>
