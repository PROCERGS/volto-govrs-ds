...
const SimboloRS = () => {
  ...
  return (
    <div className={`simboloRS ${isHighContrast ? 'high-contrast' : ''}`}>
      <a
        href="https://casacivil.rs.gov.br/inicial"
        target="_self"
        aria-label="Governo do Estado do Rio Grande do Sul"
      >
        <svg
          role="img"
          width="85"
          ...
          focusable="false"
        >
          <title>RS.GOV - Novas façanhas</title>
          <desc>Governo do Estado do Rio Grande do Sul</desc>
          <rect width="84.697" height="111" fill="url(#pattern0_960_8773)" />
          <defs>
            <pattern
              id="pattern0_960_8773"
              patternContentUnits="objectBoundingBox"
              width="1"
              height="1"
            >
              <use
                xlinkHref="#image0_960_8773"
